...
div
  ...
  trix-editor(
    ...
    @trix-attachment-remove="attachment_remove"
...
module.exports = editor
  ...
  methods:
    get_content: ->
      @log.text = @editor.getDocument().toString()
      @log.html = @$refs.input?.value
