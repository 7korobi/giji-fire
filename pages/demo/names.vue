...
{ country, name, timestamp } = require '../../../giji/app/yaml/work_namedb.yml'
Set.work_country.set country
Set.work_name.set name
console.log timestamp


{ name, timestamp } = require '../../../giji/app/yaml/work_namedb_ancient.yml'
Set.work_name.merge name
console.log timestamp

{ name, timestamp } = require '../../../giji/app/yaml/work_namedb_jpn.yml'
Set.work_name.merge name
console.log timestamp
